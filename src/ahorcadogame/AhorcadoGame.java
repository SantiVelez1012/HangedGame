        ...
        do{
            ...
            do{
                ...
                if(numeroFallos == fallosMaximos){
                    ...
                    System.out.println("");
                    System.out.println("------------------------------------");
                    System.out.println("Sus intentos totales fueron: " + numeroIntentos);
                    System.out.println("Sus errores totales fueron: " + numeroFallos);
                    System.out.println("FELICIDADES POR COMPLETAR EL JUEGO!");
                    System.out.println("Usted Ha ganado el juego");
                    System.out.println("");
                    System.out.println("Desea jugar de nuevo? 1 - SI, 0 - NO");
                    comprobacion = teclado.nextByte();
                    break;
                }
